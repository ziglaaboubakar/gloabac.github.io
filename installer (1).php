...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210616_globalaction_6277e79ea5a30c3f8539_20210616123917_archive.zip';
	const ARCHIVE_SIZE		 = '160239077';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '6277e79-16123917';
    const SECONDARY_PACKAGE_HASH = '235af74-16123917';
	const VERSION			 = '1.4.1';
	...
	public function run()
	{
		...
		self::log('==DUPLICATOR INSTALLER BOOTSTRAP v1.4.1==');
		self::log('----------------------------------------------------');
